...
const style = {
  wrapper: `relative flex h-[450px] w-[340px] cursor-pointer flex-col rounded-lg bg-black shadow-lg transition-all duration-300 hover:shadow-2xl dark:bg-[#333333]`,
  ...
  maticImageContainer: `flex items-center justify-end space-x-2`,
      ...
      <div className = {style.nftInfoContainer}>
        <div>
          {listing.asset.collection && (
            <div className = {style.collection.Title}> 
        ...
        <div className = {style.priceTitle}> Buy at</div>
          <div className = {style.maticImageContainer}>
            <Image 
            height = {16}
            width = {16}
            src = '/matic-logo.png'
